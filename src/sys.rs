...
pub enum ReturnProtocol {
    Error = ior!('r', 0, size_of::<i32>()),
    Ok = io!('r', 1),
    Transaction = ior!('r', 2, size_of::<binder_transaction_data>()),
    Reply = ior!('r', 3, size_of::<binder_transaction_data>()),
    AcquireResult = ior!('r', 4, size_of::<i32>()),
    DeadReply = io!('r', 5),
    TransactionComplete = io!('r', 6),
    IncRefs = ior!('r', 7, size_of::<binder_ptr_cookie>()),
    Acquire = ior!('r', 8, size_of::<binder_ptr_cookie>()),
    Release = ior!('r', 9, size_of::<binder_ptr_cookie>()),
    DecRefs = ior!('r', 10, size_of::<binder_ptr_cookie>()),
    AttemptAcquire = ior!('r', 11, size_of::<binder_pri_ptr_cookie>()),
    Noop = io!('r', 12),
    SpawnLooper = io!('r', 13),
    Finished = io!('r', 14),
    DeadBinder = ior!('r', 15, size_of::<binder_uintptr_t>()),
    ClearDeathNotificationDone = ior!('r', 16, size_of::<binder_uintptr_t>()),
    FailedReply = io!('r', 17),
}
